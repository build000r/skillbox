...
help:
	...
	@printf "  make runtime-sync   Create managed repo/log dirs and install default skills\n"
	@printf "  make runtime-status Summarize repo/skill/service/log state\n"
	@printf "  make dev-sanity     Validate runtime graph, paths, and skill integrity\n"
